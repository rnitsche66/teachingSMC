...
BUILD_ERROR                    = [sprintf('DSRT MAKE ERROR: Make process failed for model FFT4dSpace_1.')]
SYS_TARGET_FILE                = any
PROJ_MARKER_FILE               = no
...
DS_PROTECTION                     = OFF
MW_MAKEFILE                       = FFT4dSpace_1.mk
MW_BUILDARGS                      =  MAT_FILE=0 COMBINE_OUTPUT_UPDATE_FCNS=0 INCLUDE_MDL_TERMINATE_FCN=1 MULTI_INSTANCE_CODE=0 OPTS="-DTID01EQ=1"
# MW_MATLAB_ROOT                  = "C:\Appl\MATLAB\R2021a"
# MW_MATLAB_BIN                   = "C:\Appl\MATLAB\R2021a\bin"
MATLAB_ROOT                       = C:\Appl\MATLAB\R2021a
MATLAB_BIN_ALT                    = C:\Appl\MATLAB\R2021a\bin
MW_RELEASE_VERSION                = R2021a
MW_RELEASE_VERSION               := $(MW_RELEASE_VERSION,S'\.'_',W_,LC,S'^r'')
# MW_COMPUTER                     = PCWIN64
MW_MODEL                          = FFT4dSpace_1
MW_MODEL_MODULES                  = FFT4dSpace_1_data.c FFT4dSpace_1_dsrtmdlfcn.c FFT4dSpace_1_dsrtmf.c FFT4dSpace_1_dsrttf.c FFT4dSpace_1_dsrtvdf.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
# MW_MODEL_MODULES_OBJ            = FFT4dSpace_1_data.obj FFT4dSpace_1_dsrtmdlfcn.obj FFT4dSpace_1_dsrtmf.obj FFT4dSpace_1_dsrttf.obj FFT4dSpace_1_dsrtvdf.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj 
MW_S_FUNCTIONS                    = 
# MW_S_FUNCTIONS_OBJ              = 
MW_S_FUNCTIONS_LIB                = 
# MW_SOLVER                       = 
...
MASTER_ANCHOR_DIR                 = 
START_DIR                         = C:\workspace\teachingSMC\FFT\dSpace\SCALEXIO
...
MW_MODELREFS                      = 
MW_MODELREF_LINK_RSPFILE          = FFT4dSpace_1_ref.rsp
...
INTERFACE_LIB_$(LIB_BASENAME)_CC_SRC_FILES := FFT4dSpace_1.$(MW_TARGET_LANG_EXT) 

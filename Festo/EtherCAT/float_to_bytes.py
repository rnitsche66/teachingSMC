"""
float_to_bytes.py – Konvertiert eine Dezimalzahl in ihre 4-Byte-Darstellung (IEEE 754, Little-Endian).

Verwendung:
    python float_to_bytes.py <zahl>
    python float_to_bytes.py 0.05
